...
- **Devices to test:** Chrome DevTools (iPhone SE, Pixel 7, iPad)
...
- **Expected Result:** Usable content visible within 5 seconds.
- **Last Tested:**
- **Result:** [ ] Pass [ ] Fail

### [PERF-002] Large Data Volume

- **Steps:** Load the app with 200+ stories (10x normal usage)
